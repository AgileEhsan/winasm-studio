; This is a demonstration AddIn using Docking Windows. By Antonis Kyprianou
.386
...
Local Rect2	:RECT
	...
	.If uMsg == WM_SIZE
		...
		Invoke GetDlgItem,hWnd,1001	;combo
		PUSH EAX
		Invoke MoveWindow,EAX,0,0,Rect1.right,Rect1.bottom,TRUE
		POP ECX
		Invoke GetWindowRect,ECX,ADDR Rect2	;Rect2 needed to calculate height of combo only
		Invoke GetDlgItem,hWnd,1000	;edit
		...
		SUB ECX,EDX
		Invoke MoveWindow,EAX,0,EDX,Rect1.right,ECX,TRUE
	.EndIf
	MOV EAX,FALSE
	RET
DlgProc EndP
...
Local IsActiveChildMaximized:DWORD
	...
	MOV AddInDockData.NoDock.dWidth,340
	MOV AddInDockData.NoDock.dHeight,260
	...
	invoke GetPrivateProfileStruct,offset szSample,offset szDockingData,
	                               offset AddInDockData,40,offset szINI
	                               
	; Look 40; NOT sizeof DOCKINGDATA
...
invoke CreateDialogParam,hInstance,200,hAddIn,offset DlgProc,0
MOV hEditBox,EAX
Invoke SizeEditBox
...
WAAddInUnload Proc
	...
	; invoke RtlMoveMemory,offset AddInDockData,eax,sizeof DOCKINGDATA
	
	
	invoke WritePrivateProfileStruct,offset szSample,offset szDockingData,
	                                 offset AddInDockData,40,offset szINI
	; Look 40; NOT sizeof DOCKINGDATA
